...
namespace hw6
{
    ...
    void QuadTree::test(int t)
    {
        ...
        {
            cout << "测试5: Distance between Point and Polygon with interior ring" << endl;
            ...
            points.push_back(Point(-2, -1));
            points.push_back(Point(0, 3));
            LineString iring(points);
            Polygon poly(ering, iring);
            points.clear();
            points.push_back(Point(5, 4));
            points.push_back(Point(0, 0));
            points.push_back(Point(0, 3));
        ...
        {
            cout << "测试6: Polygon and Envelope Intersect" << endl;
