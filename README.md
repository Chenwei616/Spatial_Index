...
1. 基于提供的Geometry、Point、LineString (折线)和Polygon空间数据类型层次结构
   ...
   **扩展要求(至少完成一个)：**
   ...
   ![1](C:\Users\Genius\Desktop\22 fall and winter\Spatial data base\hw6\src\1.gif)
...
2. 基于提供的Envelope类
   ...
   **扩展要求(可选)：**
   ...
   ![2](C:\Users\Genius\Desktop\22 fall and winter\Spatial data base\hw6\src\2.jpg)
...
3. 基于提供的QuadNode和QuadTree类实现四叉树创建与查询
   ...
   **基本要求(必须完成)：**
   ...
   1. 实现constructQuadTree和split函数，创建四叉树
      ...
      ![3](C:\Users\Genius\Desktop\22 fall and winter\Spatial data base\hw6\src\3.jpg)
   ...
   2. 实现rangeQuery函数，完成区域查询
      ...
      ![4](C:\Users\Genius\Desktop\22 fall and winter\Spatial data base\hw6\src\4.jpg)
   ...
   3. 实现NNQuery和pointInLeafNode函数，完成最邻近几何特征查询
      ...
      ![5](C:\Users\Genius\Desktop\22 fall and winter\Spatial data base\hw6\src\5.jpg)
